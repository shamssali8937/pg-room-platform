...
import { LayoutDashboard, Search, CalendarCheck, MessageSquare, ShieldCheck } from "lucide-react";
...
function TenantLayoutInner({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className={`min-h-screen font-body transition-colors ${bgClass} selection:bg-violet-500/30 selection:text-violet-200`}>
            ...
            <div className={`md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 px-5 py-3.5 rounded-full border z-[45] flex items-center gap-6 shadow-2xl backdrop-blur-[20px] transition-colors ${
